                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header card-header-tabs-basic nav justify-content-center"
                                        role="tablist">
                                        <div data-toggle="chart" data-target="#locationDoughnutChart"
                                            data-update='{"data":{
                                    ...
                                    <div class="card-body">
                                        <a href="#">
                                            <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"
                                                width="30%" style="fill: currentColor;" clip-rule="evenodd"
                                                stroke-linejoin="round" stroke-miterlimit="1.414">
                                                <path
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title"><a href="" class="headings-color">UI Design &amp;
                                            Code</a></h5>
                                    <p class="card-text">I want to talk about two things that are quite important to
                                        me. These are love and one my personal inadequacies. The thing is that I’m quite
                                        fond of love...</p>
                                </div>
