...
<html lang="en" data-bs-theme="auto">
  <head><script src="../assets/css/app.cs"></script>
...
<main class="container">
  <div class="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
    <div class="col-lg-6 px-0">
      ...
      <p class="lead my-3">¡Nos complace darte la bienvenida a nuestro espacio! Somos un salón dedicado a brindarte los mejores servicios para que te sientas y luzcas genial. Nuestro compromiso es ofrecerte una experiencia excepcional en cada visita.</p>
    </div>
  </div>
    ...
    <div class="col-md-6">
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative ">
        ...
        <h5 class="card-header d-inline-block mb-2 text-success-emphasis">Inventario</h5>
          ...
          <br>
          <p class="card-text mb-auto"> Aquí puedes administrar todos los productos disponibles en nuestro salón de belleza de manera eficiente y conveniente.</p>
    ...
    <div class="col-md-6">
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        ...
        <h5 class="card-header d-inline-block mb-2 text-success-emphasis">Inventario</h5>
          ...
          <br>
          <p class="card-text mb-auto"> Aquí puedes administrar todos los proveedores que tienes disponibles y puedes agregar o elminar.</p>
...
<div class="col-md-6">
  <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
    ...
    <br>
      <p class="card-text mb-auto"> Aquí puedes administrar todos los servicios disponibles en nuestro salón de belleza de manera eficiente y conveniente.</p>
...
<div class="col-md-6">
  <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
    <div class="col p-4 d-flex flex-column position-static">
      ...
      <br>
      <p class="card-text mb-auto"> Aquí puedes administrar todos las citas disponibles en nuestro salón de belleza de manera eficiente y conveniente.</p>
    ...
    <div class="col-md-4">
      <div class="position-sticky" style="top: 2rem;">
        <div class="p-4 mb-3 bg-body-tertiary rounded">
          ...
          <p class="mb-0">Sala de Belleza, expertos en color y tratamientos especializados para el cabello.</p>
        </div>
        <div class="p-4 mb-3 bg-body-tertiary rounded">
