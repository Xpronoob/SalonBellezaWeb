...
<div class="modal fade" id="create" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <!-- Se ajusta el tamaño del modal a "modal-lg" para mantener el ancho actual -->
                ...
                <div class="modal-body" style="overflow-x: auto;"> <!-- Se permite el desplazamiento horizontal -->
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <label for="product_name" class="form-label">Nombre del Producto<span
                            ...
                            <div class="mb-3">
                                <label for="stock_quantity" class="form-label">Cantidad en Stock<span
                                        class="text-danger">*</span></label>
