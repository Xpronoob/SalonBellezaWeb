                ...
                @forelse  ($categories as $category)
                    <tr class="">
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-success" href="{{ route('category.edit',$category->id_category) }}">Editar</a>
                            <button type="button" class="btn btn-danger" data-toggle="modal"  data-target="#delete{{$category->id_category}}">Eliminar</button>
                        </td>
