...
<head>
    ...
    <title>Gestione sus productos</title>
            ...
            <div class="mdk-drawer-layout js-mdk-drawer-layout" data-push data-responsive-width="992px">
                <div class="mdk-drawer-layout__content page">
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-lg-12 card-form__body card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="validationSample01">Nombre del Producto</label>
                                    <input type="text" class="form-control" id="validationSample01"
                                        placeholder="Nombre " value="Mascarilla Facial" required="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="validationSample01"
                                        ...
                                        value="Mascarilla facial de carbon activado" required="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="validationSample01"
                                        placeholder="Categoria del producto" value="Estetica" required="">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="validationSample01">Precio</label>
                                    <input type="text" class="form-control" id="validationSample01"
                                        placeholder="¢" value="¢9500" required="">
                    ...
                    <div class="card card-form">
                        <div class="row no-gutters">
                            ...
                            <div class="col-lg-12 card-form__body card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="validationSample01">Descripción</label>
                                    <input type="text" class="form-control" id="validationSample01"
                                        placeholder="Descripción del producto" value="" required="">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="validationSample01">Categoria</label>
                                    <input type="text" class="form-control" id="validationSample01"
                                        placeholder="Categoria del producto" value="" required="">
                        ...
                        <button type="button" class="btn btn-primary">Agreagar producto</button>
