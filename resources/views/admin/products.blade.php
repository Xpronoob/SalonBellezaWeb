                                            ...
                                            <table class="table mb-0 thead-border-top-0">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="width: 55px;">Descripción</th>
                                                        <th style="width: 55px;">Categoria</th>
                                                        <th style="width: 55px;">Precio</th>
                                                        <th style="width: 55px;">Editar</th>
                                                ...
                                                <tbody class="list"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <span class="js-lists-values-employee-name">Loción</span></td>

                                                        
                                                        <td><small class="js-lists-values-employee-name">Loción limpiadora para la cara</small></td>
                                
                                                        <td> <span class="js-lists-values-employee-name">Estetica</span></td>
                                                        <td>¢3500</td>
                                                        <td><a href=""
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <span class="js-lists-values-employee-name">Labial</span></td>

                                                        
                                                        <td><small class="js-lists-values-employee-name">Labial mate color rojo</small></td>
                                
                                                        <td> <span class="js-lists-values-employee-name">Maquillaje</span></td>
                                                        <td>¢2500</td>
                                                        <td><a href=""
                                                            class="text-muted"><i class="material-icons">edit</i></a></td> </td>
                                                        <td><a href=""
                                                    ...
                                                    <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> <span class="js-lists-values-employee-name">Keratina</span></td>
    
                                                            
                                                            <td><small class="js-lists-values-employee-name">Keratina en tubo</small></td>
                                    
                                                            <td> <span class="js-lists-values-employee-name">Peluquería</span></td>
                                                            <td>¢4500</td>
                                                            <td><a href=""
                                                                class="text-muted"><i class="material-icons">edit</i></a></td> </td>
                                                            <td><a href=""
