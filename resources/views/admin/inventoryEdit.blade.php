...
<html lang="en"
    ...
    <head>
        ...
        <title>Gestione su inventario</title>
            ...
            <div class="mdk-header-layout__content">
                ...
                <div class="mdk-drawer-layout js-mdk-drawer-layout"
                    ...
                    <div class="mdk-drawer-layout__content page">
                        ...
                        <div class="card card-form">
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-12 card-form__body card-body">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <label for="validationSample01">Nombre del Insumo</label>
                                            <input type="text"
                                                   class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="validationSample01">Estado</label>
                                        <input type="text"
                                               class="form-control"
                                               id="validationSample01"
                                               placeholder="Estado"
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="validationSample01">Descripción</label>
                                    <input type="text"
                                           class="form-control"
                                           id="validationSample01"
                                           placeholder="Describe el insumo"
                                           value="Tinte de fantasia color verde"
                                           required="">
                            ...
                            <div class="form-group">
                                ...
                                <label for="validationSample01">Categoria</label>
                                <input type="text"
                                       class="form-control"
                                       id="validationSample01"
                        ...
                        <div class="form-group">
                            ...
                            <label for="validationSample01">Cantidad</label>
                            <input type="text"
                                   class="form-control"
                                   id="validationSample01"
                        ...
                        <div class="form-group">
                            ...
                            <label for="validationSample01">Proveedor</label>
                            <input type="text"
                                   class="form-control"
                                   id="validationSample01"
                    ...
                    <div class="form-group">
                        ...
                        <label for="validationSample01">Precio compra</label>
                        <input type="text"
                               class="form-control"
                               id="validationSample01"
                               placeholder="¢"
                ...
                <div class="form-group">
                    ...
                    <label for="validationSample01">Precio venta</label>
                    <input type="text"
                           class="form-control"
                           id="validationSample01"
                           placeholder="¢"
                           ...
                           required="">
                            ...
                            <button type="button" class="btn btn-primary">Editar insumo</button>

                        </div>
                        <br>
                        <div class="container-fluid page__container">
                            <h1 class="m-0">Añadir insumo</h1>
                        </div>
                        <div class="card card-form">
                            <div class="row no-gutters">
                ...
                <div class="form-group">
                    ...
                    <input type="text"
                           ...
                           required="">
                            ...
                            <button type="button" class="btn btn-primary">Agreagar insumo</button>
