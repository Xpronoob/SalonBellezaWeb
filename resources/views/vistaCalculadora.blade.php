<x-main-layout>
    ...
    <body>
        ...
        <h2>Calculadora</h2>
        <p>Esta calculadora básica te permite realizar operaciones aritméticas simples. Simplemente presiona los botones
            numéricos y los operadores para realizar cálculos.</p>
